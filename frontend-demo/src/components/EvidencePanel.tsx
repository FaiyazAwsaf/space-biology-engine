...
import { knowledgeGraphs } from "../data/knowledgeGraphs";

// Volcano plot image paths - these should be placed in public/assets/omics/
const volcanoPlotPreview = "/assets/omics/Omics-lens-Final-collapsed.jpg";
const volcanoPlotFull = "/assets/omics/Omics-Lens-final-expanded.jpg";
...
export function EvidencePanel({ evidenceCard }: EvidencePanelProps) {
  ...
  // Function to determine which knowledge graph to show based on domain
  const getCurrentGraphData = () => {
    // Default to bone-radiation graph for now, but this could be made dynamic
    // based on the current domain or evidence card content
    return (
      knowledgeGraphs.find((graph) => graph.id === "bone-radiation") ||
      knowledgeGraphs[0]
    );
  };
  ...
  // Detect if this is bone domain based on evidence card content
  const isBoneDomain = () => {
    const allContent = [
      ...evidenceCard.impacts,
      ...evidenceCard.mechanisms,
      ...evidenceCard.countermeasures,
      ...evidenceCard.methods,
      ...evidenceCard.caveats,
    ]
      .join(" ")
      .toLowerCase();

    return (
      allContent.includes("bone") ||
      allContent.includes("skeletal") ||
      allContent.includes("muscle") ||
      allContent.includes("osteoblast") ||
      allContent.includes("osteoclast") ||
      allContent.includes("bmd") ||
      allContent.includes("trabecular") ||
      allContent.includes("cortical")
    );
  };
  ...
  const getStrengthOfEvidence = () => {
    const totalEvidence =
      evidenceCard.impacts.length +
      evidenceCard.mechanisms.length +
      evidenceCard.countermeasures.length +
      evidenceCard.caveats.length;
  ...
  const sections = [
    {
      ...
      title: "Impacts",
      icon: Activity,
      data: evidenceCard.impacts.map((item) =>
        item.split(" ").slice(0, 10).join(" ")
      ),
      color: "text-red-400",
    ...
    },
    {
      ...
      title: "Mechanisms",
      icon: Microscope,
      data: evidenceCard.mechanisms.map((item) =>
        item.split(" ").slice(0, 10).join(" ")
      ),
      color: "text-cyan-400",
    ...
    },
    {
      ...
      icon: Shield,
      data: evidenceCard.countermeasures.map((item) =>
        item.split(" ").slice(0, 10).join(" ")
      ),
      color: "text-green-400",
    ...
    },
    {
      ...
      title: "Methods",
      icon: RefreshCw,
      data: evidenceCard.methods.map((item) =>
        item.split(" ").slice(0, 10).join(" ")
      ),
    ...
    },
    {
      ...
      title: "Caveats",
      icon: AlertTriangle,
      data: evidenceCard.caveats.map((item) =>
        item.split(" ").slice(0, 10).join(" ")
      ),
      color: "text-orange-400",
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="p-6 border-b border-cyan-500/20 bg-gradient-to-r from-slate-800/80 to-slate-800/60">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-cyan-100 text-xl tracking-wide">
                  Evidence Panel
                </h2>
                <p className="text-cyan-300/70 text-sm">
                  Structured biological insights
                </p>
              </div>
            </div>
            ...
            <div
              className={`flex items-center gap-2 px-3 py-2 rounded-xl ${strengthOfEvidence.bg} ${strengthOfEvidence.border} border backdrop-blur-sm shadow-lg ${strengthOfEvidence.glow}`}
            >
              <span className="text-lg">{strengthOfEvidence.emoji}</span>
              <div className="text-right">
                <div
                  className={`text-sm ${strengthOfEvidence.color} tracking-wide`}
                >
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <h3
                          className={`text-sm ${section.color} tracking-wide`}
                        >
                          {section.title}
                        </h3>
                    ...
                    <div className="flex items-center gap-2">
                      <div
                        className={`flex items-center justify-center w-8 h-8 rounded-lg ${section.bgColor} ${section.borderColor} border backdrop-blur-sm`}
                      >
        ...
        <div className="flex-1 p-3 border-t border-cyan-500/10 bg-gradient-to-r from-slate-800/80 to-slate-800/60 min-h-0">
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              <div className="flex items-center gap-1 text-xs text-cyan-300/60">
                ...
                <span>
                  {currentView === "graph" ? "Neural Map" : "Multi-Omics"}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col" style={{ minHeight: "200px" }}>
            {currentView === "graph" ? (
              <div
                className="relative flex-1 bg-slate-900/20 rounded-xl border border-cyan-500/20 overflow-hidden"
              ...
              <div
                className="flex-1 bg-slate-900/20 rounded-xl border border-cyan-500/20 p-3 overflow-hidden"
                style={{ minHeight: "180px" }}
              >
                {isBoneDomain() ? (
                  // Bone Domain - Volcano Plot Preview
                  <div className="h-full flex flex-col">
                    ...
                    {/* Volcano Plot Preview Image */}
                    <div className="flex-1 flex items-center justify-center">
                      <div className="relative max-w-full max-h-full">
                        <img
                          src={volcanoPlotPreview}
                          alt="Volcano Plot Preview - Bone & Muscle OSD-467"
                          className="max-w-full max-h-full object-contain rounded-lg border border-cyan-500/20 shadow-lg"
                        ...
                        <div className="hidden flex items-center justify-center w-full h-20 bg-slate-800/40 rounded-lg border border-cyan-500/20">
                    ...
                    <div className="text-center text-xs text-cyan-400/40 mt-2">
                      HLU vs Control • Cortical Bone
                    </div>
                  </div>
                ) : (
                  // Other Domains - Original Omics Lens
                  <div>
                    <div className="flex items-center justify-center gap-2 mb-3">
                      <span>🧬</span>
                      <span className="text-cyan-200 text-sm">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="bg-slate-800/40 rounded p-2">
                        <div className="text-xs text-cyan-200 mb-1 text-center">
                          Pathways
                        </div>
          ...
          createPortal(
            <div className="fixed inset-0 bg-black/70 backdrop-blur-md z-[9999] flex items-center justify-center p-8">
              <div className="relative bg-slate-900/95 backdrop-blur-lg rounded-2xl border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 max-w-7xl w-full max-h-[85vh] overflow-hidden">
                ...
                <div
                  className="relative p-6 bg-slate-900/40 backdrop-blur-sm overflow-y-auto"
                  style={{ height: "600px" }}
                >
                  {currentView === "graph" ? (
                    <div className="w-full h-full">
                      <KnowledgeGraph data={getCurrentGraphData()} />
                    </div>
                  ) : (
                    /* Expanded Omics Lens - Bone Domain or Default */
                    <div className="w-full h-full overflow-y-auto">
                      {isBoneDomain() ? (
                        // Bone Domain - Full Volcano Plot
                        <div className="space-y-6">
                          <div className="bg-slate-800/40 backdrop-blur-sm rounded-2xl border border-cyan-500/20 p-6">
                            <h3 className="text-cyan-100 text-xl mb-6 flex items-center justify-center gap-3">
                              <span>🦴</span>
                              <span>Omics Lens - Bone & Muscle (OSD-467)</span>
                            </h3>

                            {/* Full Volcano Plot Image */}
                            <div className="flex justify-center mb-6">
                              <div className="relative max-w-full">
                                <img
                                  src={volcanoPlotFull}
                                  alt="Full Volcano Plot - Bone & Muscle OSD-467 with Gene Expression Data"
                                  className="max-w-full h-auto rounded-xl border border-cyan-500/20 shadow-2xl shadow-cyan-500/10"
                                ...
                                />
                                {/* Fallback placeholder */}
                                <div className="hidden flex flex-col items-center justify-center w-full h-96 bg-slate-800/40 rounded-xl border border-cyan-500/20">
                                  <div className="text-center">
                                    <div className="text-6xl mb-4">📊</div>
                                    <h4 className="text-cyan-100 text-lg mb-2">
                                      Volcano Plot - OSD-467
                                    </h4>
                                    <p className="text-cyan-300/60 text-sm mb-2">
                                      HLU vs Control, Cortical Bone
                                    </p>
                                    <p className="text-cyan-400/40 text-xs">
                                      Top Differentially Expressed Genes
                                    </p>
                                    <div className="mt-4 text-xs text-cyan-400/30">
                                      [Image placeholder - Please add
                                      volcano-plot-full.png to assets/omics/]
                                    </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div className="text-center text-sm text-cyan-300/60">
                              <strong>Takeaway:</strong> Hindlimb unloading
                              upregulates stress/remodeling genes (Mmp3, Mmp13),
                              metabolic activators (Pfkfb3, Scd1), while
                              osteoblast/osteocyte signaling genes show moderate
                              increases. Dataset: OSD-467 (Cortical bone,
                              11-week female mice).
                            </div>
                          </div>
                          ...
                          <div className="bg-slate-800/40 backdrop-blur-sm rounded-2xl border border-cyan-500/20 p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                              <div className="bg-slate-700/30 rounded-lg p-4">
                                <h5 className="text-cyan-200 font-medium mb-2">
                                  Upregulated Genes
                                </h5>
                                <ul className="text-cyan-300/80 space-y-1">
                                  <li>• Scd1 (2.0x) - Lipid synthesis</li>
                                  <li>• Pfkfb3 (1.8x) - Glycolysis</li>
                                  <li>• Mmp3 (1.8x) - Matrix degradation</li>
                                </ul>
                              </div>
                              <div className="bg-slate-700/30 rounded-lg p-4">
                                <h5 className="text-cyan-200 font-medium mb-2">
                        ...
                        // Other Domains - Original Expanded Omics Lens
                        <div className="space-y-6">
                          ...
                          <div className="bg-slate-800/40 backdrop-blur-sm rounded-2xl border border-cyan-500/20 p-6">
                            ...
                            <div className="text-center text-sm text-cyan-300/60">
                              NASA GLDS-104 • Microgravity vs Ground Control •
                              1,536 genes analyzed
                            </div>
                          </div>
                          ...
                          <div className="grid grid-cols-2 gap-8">
                            <div className="bg-slate-800/40 backdrop-blur-sm rounded-2xl border border-cyan-500/20 p-6">
                              ...
                              <div className="flex items-end justify-center gap-3 h-40">
                                {[
                                  85, 92, 67, 78, 95, 81, 73, 89, 76, 88, 94,
                                  82,
                                ].map((height, i) => (
                                  <div
                                    key={i}
                            ...
                            <div className="bg-slate-800/40 backdrop-blur-sm rounded-2xl border border-cyan-500/20 p-6">
                              ...
                              <div className="flex items-end justify-center gap-3 h-40">
                                {[
                                  72, 58, 91, 64, 87, 75, 82, 69, 79, 85, 71,
                                  93,
                                ].map((height, i) => (
                                  <div
                                    key={i}
