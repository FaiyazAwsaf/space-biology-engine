...
interface HomepageProps {
  onStartConversation: (query: string, domain?: string, filters?: FilterState) => void;
  onNavigateToDashboard: () => void;
}

export function Homepage({ onStartConversation, onNavigateToDashboard }: HomepageProps) {
  ...
  const handleStartExploring = () => {
    // Inject sample question into search bar (requires manual search to start conversation)
    const sampleQuestions = [
      "How does microgravity affect bone remodeling and muscle?",
    ...
    if (searchInput) {
      ...
      setTimeout(() => {
        searchInput.parentElement?.parentElement?.classList.remove('animate-pulse');
      }, 2000);
    }
  };
      ...
      <section className="relative z-10 px-6 pt-16 pb-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-emerald-200/80 text-lg max-w-2xl mx-auto mb-12 leading-relaxed">
            Explore the convergence of life and cosmos through AI-powered insights from cutting-edge space biology research
          </p>
          ...
          <div className="max-w-md mx-auto">
            <div className="mb-4 text-center">
              <div className="text-emerald-200/70 text-sm tracking-wide mb-3">Live Research Insights</div>
            </div>
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-8 pb-16">
        ...
        <section ref={domainsRef} className="mb-16 scroll-mt-8">
          <div className="mb-8 border-l-2 border-emerald-500/30 pl-4">
            <h2 className="text-emerald-100/90 tracking-wide">Research Domains</h2>
            <div className="text-emerald-400/60 text-sm mt-1">// Six primary biological systems</div>
          </div>
        ...
        <section ref={activeResearchRef} className="mb-12 scroll-mt-8">
          <div className="mb-8 border-l-2 border-cyan-500/30 pl-4">
            <h2 className="text-emerald-100/90 tracking-wide">Active Research</h2>
            <div className="text-cyan-400/60 text-sm mt-1">// Current biological discoveries</div>
          </div>
          <TrendingInsights />
        </section>
